...
Ease.js is a full-stack framework designed for speed and ease of use.

- **Simplified Syntax**: Use `.easjs` files to write cleaner code.
- **Unified Logic**: Handle Frontend, Backend, and Middlend in one project.
